package com.example.mozeeb.jadwalsholat;
...
import com.example.mozeeb.jadwalsholat.api.ApiService;
import com.example.mozeeb.jadwalsholat.api.ApiUrl;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tv_isha_value = findViewById(R.id.tv_isyak_value);
        fab_refresh = findViewById(R.id.floatingActionButton);
